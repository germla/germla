...
import { MdList, MdSettings, MdPeople, MdAdd } from 'react-icons/md';
...
export default function Sidebar({ workspace }: { workspace: Workspace }) {
  ...
  return (
    <aside className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -tranzinc-x-full sm:tranzinc-x-0">
