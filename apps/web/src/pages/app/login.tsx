              ...
              <div className="md:pt-40 md:pb-20 pt-32 pb-12">
                ...
                <div className="max-w-sm mx-auto">
                  ...
                  <div className="flex items-center my-4">
                    <div className="flex-grow border-t border-slate-300 mr-3" />
                    <div className="italic text-slate-400 text-sm">or</div>
                    <div className="flex-grow border-t border-slate-300 ml-3" />
                  </div>
                  <div className="flex">
