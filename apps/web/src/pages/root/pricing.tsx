    ...
    <>
      ...
      <section className="relative">
        <div className="pointer-events-none absolute inset-0 -z-10 overflow-hidden ">
          <div className="absolute left-2/4 top-0 flex aspect-square w-2/6 -translate-x-2/4 -translate-y-2/4 items-center justify-center">
          ...
          <div className="py-12 md:py-20">
            <div className="mx-auto max-w-3xl pb-12 text-center md:pb-20">
              <div>
                ...
                <h2 className="pricing-heading bg-gradient-to-r from-slate-950/60 via-slate-950 to-slate-950/60 bg-clip-text pb-4 text-transparent">
                  Flexible plans and features
                </h2>
              </div>
            </div>
            <div className="relative">
              <div className="pointer-events-none absolute bottom-0 left-2/3 -mb-20 -translate-x-2/4 opacity-70 backdrop-blur-[40px]" />
              <div className="pricing-tabs c6kmo c0wh7 c1zsb cyara cdaqh cy78w cn9ih c11pb c3508 c9hqb cz5uy c7xar cb7qe csixx coqyr czetz ci38e c0im3 cvvj2 clijk c5zlb cp28w ckam3 cazi3 cthht c7z5n chaby cpa4l ccmry ctdge grid md:grid-cols-5">
                ...
                <div className="flex flex-col items-center justify-end bg-transparent px-6 py-10">
                  <div className="border-slate-200 pb-5 md:border-b">
                    <Switch.Group>
                      <div className="flex items-center">
                        ...
                        <Switch
                          ...
                          className={`${
                            annually ? "bg-indigo-500" : "bg-slate-300"
                          } relative flex h-6 w-11 cursor-pointer items-center rounded-full outline-slate-400 transition-colors duration-150`}>
                          <span
                            className={`${
                ...
                {/* Pricing Card Free */}
                <div className="flex flex-col justify-end border-r border-slate-200 bg-white/75 px-6 py-6 md:rounded-tl-3xl">
                  <div className="mb-4 flex-grow border-b border-slate-200 pb-4">
                    <div className="inline-flex bg-gradient-to-r from-indigo-600 to-indigo-400 bg-clip-text text-transparent">
                      Free
                    </div>
                    <div className="mb-1">
                      <span className="dollar-sign font-medium text-slate-500">$</span>
                      <span className="price font-bold text-slate-800">{annually ? 0 : 0}</span>
                      <span className="font-medium text-slate-500">{annually ? "/yr" : "/mo"}</span>
                    </div>
                  </div>
                </div>
                {/* Pricing Card Basic */}
                ...
                <div className="flex flex-col justify-end bg-white/75 px-6 md:border-r md:border-slate-200">
                  <div className="mt-4 py-2 font-medium text-slate-500 md:hidden">Feedback</div>
                </div>
                ...
                <div className="flex flex-col justify-end bg-white/75 px-6">
                  <div className="mt-4 py-2 font-medium text-slate-800 md:hidden">Feedback</div>
                </div>
                {/* Sentiment Analysis */}
                <div className="hidden flex-col justify-end bg-transparent px-6 md:flex">
                  <div className="border-b border-slate-300 py-2 text-sm font-medium">
                    Sentiment Analysis
                  </div>
                </div>
                <div className="flex flex-col justify-end bg-white/75 px-6 md:border-r md:border-slate-200">
                  <div className="mt-4 border-b border-slate-300 py-2 font-medium text-slate-500">
                    <svg
                ...
                <div className="flex flex-col justify-end rounded-bl-3xl rounded-br-3xl bg-white/75 px-6 pb-6 md:rounded-br-none md:border-r md:border-slate-200">
                  <div className="mt-4 border-b border-slate-300 py-2 font-medium text-slate-500">
                    <svg
                      className="mr-3 flex-shrink-0 fill-indigo-500"
                      xmlns="http://www.w3.org/2000/svg"
